      ...
      <div className="row g-5">
        ...
        <div className="col-md-6 experience">
          <div className="dark-color text-white rounded-3 h-100 row align-items-center">
            <div className="col-md-12 about-home">
        ...
        <div className="col-md-6 experience">
          <div className="dark-color text-white rounded-3 h-100 text-center p-4 experience">
        ...
        <div className="col-md-6 experience">
          <div className="dark-color text-white rounded-3 h-100 p-4">
          <h2>Skills</h2>
          <div className="row g-2 justify-content-around align-items-center h-100 p-2">
            <div className="col-md-6 skills text-center"><img src={html} alt="" /></div>
            <div className="col-md-6 skills text-center"><img src={js} alt="" /></div>
            <div className="col-md-6 skills text-center"><img src={css} alt="" /></div>
            <div className="col-md-6 skills text-center"><img src={react} alt="" /></div>
            <div className="col-md-6 skills text-center"><img src={jQuery} alt="" /></div>
          </div>
          </div>
        </div>
      </div>
